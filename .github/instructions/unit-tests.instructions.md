...
- Comment only non-obvious test setup or domain reasoning; test names should explain the behaviour rather than relying on comments that restate the assertions.
