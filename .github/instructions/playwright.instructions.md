...
- **Comments**: Prefer test and step names that explain behaviour; comments should explain only non-obvious setup or interaction rationale, not repeat the action.
